      ...
      <div className='flex flex-col md:flex-row items-center  relative'>
        <div className='w-full h-full md:w-1/2 flex flex-col gap-8 z-10 bg-gradient-to-r from-stone-950 via-stone-950 to-transparent'>
          ...
          <div className='flex flex-row gap-6'>
            <Link href="#preview" className='w-36 flex flex-col items-center py-3 rounded-xl text-xs bg-gradient'>Buy keybord</Link>
            <Link href='#features' className='w-36 flex flex-col items-center py-3 rounded-xl text-xs border-[1px] border-white'>See more</Link>
          </div>
        </div>
        <Image
            src="/assets/hero.png" 
